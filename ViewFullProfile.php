...
if($_GET['Username']){
    ...
    // echo $ProfileUser_data['Username'];
    // echo "<br>";
    // echo $ProfileUser_data['Age'];
    // echo "<br>";
    // echo $ProfileUser_data['Religion'];
    // echo "<br>";
    // echo $ProfileUser_data['MobileNo'];
    // echo "<br>";
    // echo $ProfileUser_data['MotherTongue'];
...
.First{
    ...
    <form action="Result.php?To=<?php echo $row['Username']?> " method="post">

    <div class="image"><?php echo "Photo:<img src='$link' alt='Profile Photo' width=400 height=350></img></br>";?></div>

        <h3 class="First"><?php echo "Gender:<strong>".$row['Gender']."</strong></br>";?></h3>
        <h3><?php echo "Contact No:xxxxxxxxx</br>";?></h3>
    ...
    <h3 style="display: inline;">Would You Like This Profile:</h3>
        <input type="radio" id="male" name="Ans" value="Accept" required>
        <label for="male">Accept</label>
        <input type="radio" id="female" name="Ans" value="Decline" required>
        <label for="female">Decline</label>
        <br><br>
        <button type="submit" class="btn">Submit Your Respone</button>
    </form>
    </body>
    </html>
<?php
